...
final class AudioBufferPolicy {
    ...
    static int configure(Track track,int producerFrames,boolean hasStartThreshold)throws IOException {
        ...
        // Restore the 0.2.0 start behavior. Wine controls its own priming;
        // imposing a second 20 ms watermark regressed sound on Thor and can
        // prevent a short sound from draining. Keep the real playback clock.
